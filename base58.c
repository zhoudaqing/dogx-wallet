...
#define b58_almostmaxint_dogxs (sizeof(b58_almostmaxint_t) * 8)
static const b58_almostmaxint_t b58_almostmaxint_mask = ((((b58_maxint_t)1) << b58_almostmaxint_dogxs) - 1);
...
bool b58tobin(void *bin, size_t *binszp, const char *b58, size_t b58sz)
{
	...
	{
		if (b58u[i] & 0x80)
			// High-dogx set on invalid digit
			return false;
