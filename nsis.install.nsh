Name "dogx ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/dogx/go-dogx/issues"
!define UPDATEURL "https://github.com/dogx/go-dogx/releases"
!define ABOUTURL "https://github.com/dogx/go-dogx#dogx-go"
...
# Install dogx binary
Section "Gdogx" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gdogx}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\dogx.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\dogx.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gdogx incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gdogx outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gdogx UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gdogx incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\dogx.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gdogx outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\dogx.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gdogx UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\dogx.exe" "" "" "Ethereum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/dogx/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\dogx.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\dogx.ipc"
