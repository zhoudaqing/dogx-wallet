...
# 1. install dogx for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for dogx
# 5. create dogx, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since dogx is installed global
